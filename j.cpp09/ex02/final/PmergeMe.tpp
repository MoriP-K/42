...
template <typename Container>
std::vector<data> PmergeMe<Container>::comparePair(void)
{
...
template <typename Container>
void PmergeMe<Container>::printArrDebug(void)
{
...
template <typename Container>
int PmergeMe<Container>::getIndexFromVector(size_t src_orig_idx, std::vector<std::vector<data> > dist)
{
...
template <typename Container>
void PmergeMe<Container>::printInfo(std::vector<Container > arr, const std::string& color)
{
	size_t width = 5;
	for (size_t i = 0; i < arr.size(); ++i)
	{
...
template <typename Container>
void PmergeMe<Container>::printArr(Container vec, std::string msg)
{
	std::cout << msg;
...
template <typename Container>
void PmergeMe<Container>::printCount()
{
