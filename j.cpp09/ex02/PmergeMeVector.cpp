...
PmergeMeVector::PmergeMeVector(const char **av)
{
...
bool PmergeMeVector::isValidArgs(const char **av)
{
	long num = 0;
...
void PmergeMeVector::startSorting(void)
{
...
std::vector<data> PmergeMeVector::comparePair(void)
{
...
std::vector<size_t> PmergeMeVector::makeJacobsthalOrder(size_t tmp_len)
{
...
std::vector<size_t> PmergeMeVector::generateInsertOrder(std::vector<size_t> jacob, size_t tmp_len)
{
...
size_t PmergeMeVector::limitedBinarySearch(size_t search_limit, size_t search_value)
{
	if (search_limit == 0)
		return (0);
...
int PmergeMeVector::binarySearch(int key)
{
	int ng = -1;
...
int PmergeMeVector::getIndexFromVector(size_t src_orig_idx, std::vector<std::vector<data> > dist)
{
...
bool PmergeMeVector::isOK(int index, size_t key)
{
	++this->_count;
...
const std::vector<data>& PmergeMeVector::getArr() const
{
	return (this->_input_arr);
}

const std::vector<std::vector<data> >& PmergeMeVector::getPairOrigIdx() const
{
	return (this->_data);
}

const size_t& PmergeMeVector::getCount() const
{
	return (this->_count);
}

size_t PmergeMeVector::arrSize(void) const
{
	return (this->_input_arr.size());
}

void PmergeMeVector::printArrBeforeSorting(void)
{
...
void PmergeMeVector::printArrAfterSorting(void)
{
...
void PmergeMeVector::printArrWIP(void)
{
