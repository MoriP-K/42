...
void PmergeMe::testMIS(std::vector<size_t> arr)
{
...
//     {
// 		this->_sorted_vec.push_back(this->_arr[chain[i]]);
//     }
// 	}
...
// 				{
// 					if (this->_sorted_vec[j] == mainValue)
// 					{
// 						insertPos = j;
// 						break;
// 					}
...
// 				{
// 					this->_sorted_vec.insert(this->_sorted_vec.begin() + insertPos, this->_arr[pendChain[j]]);
// 					insertPos++;
// 				}
// 			}
// 			else
...
// 					this->_sorted_vec.insert(this->_sorted_vec.begin() + insertPos, 
// 											pendValue);
...
// 			this->_sorted_vec.insert(this->_sorted_vec.begin() + pos, value);
// 		}
// 	}
// }
