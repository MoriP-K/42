...
/*   Updated: 2026/09/03 18:33:27 by kmoriyam         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void							handle_icmp_error(t_ping *ping,
									t_ip_hdr *outer_ip, t_icmp *error_packet);
...
void							throw_error(const char *func_name,
									struct addrinfo *ai);

void							print_reply_status(t_ping *ping, t_icmp *reply);
void							print_target(t_ping *ping);
void							print_result(t_stat stat, char *hostname,
									struct addrinfo *ai);
void							print_header_dump(t_ip_hdr *ip_header,
