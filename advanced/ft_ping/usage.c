...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/04/15 00:39:55 by morip             #+#    #+#             */
/*   Updated: 2026/04/15 00:40:50 by morip            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	printf("Mandatory or optional arguments to \
		long options are also mandatory or optional\n");
	printf("for any corresponding short options.\n");
	printf("\n");
	printf("Options marked with (root only) \
		are available only to superuser.\n");
	printf("\n");
